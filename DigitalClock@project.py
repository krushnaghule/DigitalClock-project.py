...
clock = Tk()
clock.wm_title('      ****** Digital Clock ******')
clock.wm_geometry('1000x500')
...
lab_mo_min=Label(clock,text="Month",font=('Time New Roman',20,"bold"),
             bg='red',fg="white")
lab_mo_min.place(x=340,y=410,height=40,width=100)

lab_year=Label(clock,text="00",font=('Time New Roman',60,"bold"),
             bg='red',fg="white")
lab_year.place(x=560,y=270,height=110,width=100)
lab_year_sec=Label(clock,text="Year",font=('Time New Roman',20,"bold"),
             bg='red',fg="white")
lab_year_sec.place(x=560,y=410,height=40,width=100)

lab_day=Label(clock,text="00",font=('Time New Roman',35,"bold"),
             bg='red',fg="white")
lab_day.place(x=780,y=270,height=110,width=100)
lab_day_am=Label(clock,text="Day",font=('Time New Roman',20,"bold"),
             bg='red',fg="white")
lab_day_am.place(x=780,y=410,height=40,width=100)
